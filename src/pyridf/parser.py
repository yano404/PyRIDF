...
class parser:
    ...
    def parse(self, content, maxblock=None):
        ...
        while self.cursor < self.size:
            ...
            if ly == 0:
                ...
                r.block.append(self.current_blk)
                ...
                if cid == 8:
                    ...
                    r.event.append(self.current_evt)
                ...
                if cid == 4:
                    ...
                    self.cursor += size*self.word_size
        print("")
        print(f"Number of Blocks: {len(r.block)}")
        print(f"Number of Events: {len(r.event)}")
        return r
